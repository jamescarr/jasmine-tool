...
var newServer = function(){
  ...
  server.on('suite', function(suite){
    ...
    console.log(suite.padding+suite.desc)
    console.log(suite.padding+'  Passed: ' + results.passedCount + ' Failed: ' + results.failedCount + ' Total: ' + results.totalCount)
  })
  server.on('spec', function(spec){
    var results = spec.results
    console.log(spec.padding+results.description)
    console.log(spec.padding+'  Passed: ' + results.passedCount + ' Failed: ' + results.failedCount + ' Total: ' + results.totalCount)
  })
